...
public class Parser {
     ...
     */
    static public KeyWord parseKeyWord(String fullInput){
     ...
     */
    static protected String parseInputElement(String input, String startNotation, String endNotation){
     ...
     */
    static public String parseTitle(String fullInput){
     ...
     */
    static public String parseStatus(String fullInput){
     ...
     */
    static public int parseSeverity(String fullInput){
     ...
     */
    static public Date parseDeadline(String fullInput) throws ParseException {
     ...
     */
    static public String parseOwner(String fullInput){
     ...
     */
    static public int parseIndex(String fullInput){
